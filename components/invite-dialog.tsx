...
const labels:Record<string,string>={read:'Lido',delivered:'Entregue ao destinatário',accepted:'Aceite pelo servidor WhatsApp — aguarda entrega',pending:'Pendente',sending:'A enviar',provider_queued:'Em fila na Z-API',sent:'Enviado ao WhatsApp — entrega não confirmada',uncertain:'Sem confirmação — verifica no WhatsApp',expired:'Expirado',cancelled:'Cancelado',failed:'Falhou'};
