...
export type PlayerGamesData = { playerId: string; people: { id: string; name: string; side: string }[]; games: { id: string; absentIds?: string[]; duration?: number; division: string; date: string; time: string; court: { name: string; location: string }; a: string[]; b: string[]; winner: string | null }[] };
